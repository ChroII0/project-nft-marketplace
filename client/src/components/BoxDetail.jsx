...
function BoxDetail(props) {
    ...
    return (
        <div className="offcanvas offcanvas-end w-25" tabindex="-1" id={"offcanvasRight" + props.type} aria-controls="offcanvasTop" aria-labelledby="offcanvasRightLabel">
            <div className="offcanvas-header">
                <h5 className="offcanvas-title" id={"offcanvasRightLabel" + props.type}>{props.type} Detail</h5>
                <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div className="offcanvas-body">
                <img className="card-img-top" width="10%" height="40%" src={props.img} /><hr />
